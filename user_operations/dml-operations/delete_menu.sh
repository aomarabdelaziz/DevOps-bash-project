...
. ././helpers/functions.sh
  ...
  --column="Option" \
     ...
     "Delete All By Column From $table" \
     "Main Menu" \
     "Exit")
...
case $choice in 
    ...
    "Delete All By Column From $table"). ./user_operations/dml-operations/delete_statments/delete_all_from_table_by_column.sh $dbName $table;;
    "Main Menu") mainMenu;;
